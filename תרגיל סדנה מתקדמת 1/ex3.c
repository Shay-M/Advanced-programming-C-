...
_Three * createThreeArr(int** mat, int count, int _rows, int _cols)//פונקציה מבוקשת
{
...
_ThreeList * createThreeList(int** mat, int count, int _rows, int _cols)//פונקציה מבוקשת
{
	int i, j;
